namespace HREngine.Bots
{
    ...
    public sealed class Ai
    {
        ...
        public void simmulateWholeTurnandPrint()
        {
            ...
            help.ErrorLog("###################################");
            if (this.bestmoveValue >= 1500) help.ErrorLog("DETECTED LETHAL ###################################");
            //this.bestboard.printActions();
        ...
        public bool canQueueNextMoves()
        {
            ...
            else if (this.bestmove.actionType == actionEnum.attackWithMinion)
            {
                ...
                if (Ai.Instance.bestmove.actionType == actionEnum.attackWithMinion || Ai.Instance.bestmove.actionType == actionEnum.attackWithHero)
                {
                    ...
                    {
                        //Helpfunctions.Instance.logg("캔쿼리넥스트무브 펄스 진짜찾는거");
                        //Helpfunctions.Instance.ErrorLog("캔쿼리넥스트무브 펄스 진짜찾는거");
                        return false;
                    }
