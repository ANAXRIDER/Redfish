...
namespace HREngine.Bots
{
    ...
    public class BoardTester
    {
        ...
        public static BoardTester Instance
        {
            get
            {
                return instance ?? (instance = new BoardTester());
            }
        }
        ...
        public BoardTester(string data = "")
        {
            ...
            if (this.evalFunction == "aggrowarlock") Ai.Instance.botBase = new BehaviorAggroWarlock();
            if (this.evalFunction == "aggroshaman") Ai.Instance.botBase = new BehaviorAggroshaman();
