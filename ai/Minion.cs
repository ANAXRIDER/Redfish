    ...
    public class Minion
    {
        ...
        public void minionDied(Playfield p)
        {
            ...
            if (own)
            {
                ...
                {
                    p.tempTrigger.ownSpellpowerMinionDied++;
                }
                if (this.name == CardDB.cardName.junglemoonkin && !this.silenced) p.tempTrigger.ownJunglemoonkinDied++;
            }
            else
            {
                ...
                if (this.spellpower >= 1)
                {
                    p.tempTrigger.enemySpellpowerMinionDied++;
                }
                if (this.name == CardDB.cardName.junglemoonkin && !this.silenced) p.tempTrigger.enemyJunglemoonkinDied++;
            }
            ...
            foreach (miniEnch me in enchants)
            {
                ...
                switch (me.CARDID)
                {
                    ...
                    case CardDB.cardIDEnum.EX1_363e: //blessing of wisdom
                        ...
                        continue;
                    case CardDB.cardIDEnum.EX1_363e2: //blessing of wisdom enemy
                        if (me.controllerOfCreator == ownPlayerControler) this.enemyBlessingOfWisdom++;
                        else this.ownBlessingOfWisdom++;
                        continue;
